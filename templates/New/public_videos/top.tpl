...
<div class="cover_edit_title doc_full_pg_top" style="padding-top:13px">
    ...
    <div class="button_div fl_r">
        <button onClick="PublicVideoSearch(); return false" id="se_but_load">Найти</button>
    </div>
    <div class="clear"></div>
</div>
<div class="clear"></div>
<div id="seResult">
    ...
    <div class="allbar_title" style="margin-bottom:0px;[yes]border-bottom:0px[/yes]">{videos-num} | <a href="/{adres}"
                                                                                                       onClick="Page.Go(this.href); return false"
                                                                                                       style="font-weight:normal">К
            сообществу</a></div>
    [no]
    <div class="info_center"><br/><br/><br/>На странице еще нет видеозаписей.<br/><br/><br/></div>
    [/no]
</div>