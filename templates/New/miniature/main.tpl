...
<div class="miniature_box">
    <div class="miniature_pos">
        <div class="miniature_title fl_l">Выбор миниатюры</div>
        ...
        <div class="miniature_img">
            ...
            <div id="miniature_crop_100" style="width:100px;height:100px;overflow:hidden"><img
                        src="/uploads/users/{user-id}/{ava}"/></div>
            <div id="miniature_crop_50" style="width:50px;height:50px;overflow:hidden"><img
                        src="/uploads/users/{user-id}/{ava}"/></div>
