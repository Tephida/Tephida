        ...
        <div class="no_display" id="smsblock">
            <div class="payment_block">
                Для получения <b>рублей</b> на Ваш счёт, отправьте платное SMS сообщение c текстом <b><span
                            id="smspref"></span>{sms_number}{user-id}</b> на номер <b id="smsnumber">9797</b><br/><br/>
                Стоимость сообщения равна сумме пополнения, то есть хотите пополнить на 100 руб. то SMS будет стоить 100
                руб.
            </div>
            <div class="clear"></div>
            <div class="playment_but"><b>Обратите внимание</b>, если Вы не с России, то рубли будут переведены по курсу
                и зачислены к Вам на счёт.
            </div>
        </div>
    </div>
