<div id="photo_view_{id}" class="photo_view" onClick="Photo.setEvent(event, '{close-link}')">
    ...
    <div class="photo_bg">
        ...
        <a href="/photo{uid}_{next-id}{section}"
           ...
           id="photo_href">
            <div class="photo_img_box"><img id="ladybug_ant{id}" class="ladybug_ant" src="{photo}" alt=""/>
    ...
    <div id="pinfo_{id}" class="pinfo">
        <div class="photo_leftcol">
            <div class="ratingbg">
                ...
                <div class="ratpos {rate-check}" id="ratpos{id}">
                    ...
                    <div onClick="Photo.addrating(6, {id})" class="rating"
                         style="background:url('{theme}/images/rating2.png')">5+
                    </div>
                </div>
                <img src="{theme}/images/ajax-loader.gif" id="rateload{id}" class="no_display"
                ...
                <div class="rateforowne">Всего оценок: &nbsp;<a class="cursor_pointer"
                    ...
                    Пятерок с плюсом: &nbsp;<a class="cursor_pointer" onClick="Photo.allrating({id})">{rate-max}</a>&nbsp;&nbsp;&nbsp;
        ...
        <div class="photo_rightcol">
            ...
            <div class="menuleft" style="width:209px;">
                <a href="/" onClick="Distinguish.Start({id}); return false"><img class="icon ic_mark"
                                                                                 src="{theme}/images/spacer.gif"
                                                                                 alt=""/>
                    <div>Отметить человека</div>
                </a>
                [owner]<a href="/" onClick="photoeditor.start('{photo}', '{id}', '{height}'); return false"><img
                            class="icon edit_ic" src="{theme}/images/spacer.gif" alt=""/>
                    <div>Корректировать</div>
                </a>
                <a href="/" onClick="crop.start({id}); return false"><img class="icon ic_cover"
                                                                          src="{theme}/images/spacer.gif" alt=""/>
                    <div>Поместить на мою страницу</div>
                </a>
                <a href="/" onClick="Photo.EditBox({id}, 0); return false"><img class="icon editphoto_ic"
                                                                                src="{theme}/images/spacer.gif" alt=""/>
                    <div>Редактировать фотографию</div>
                </a>
                <a href="/" onClick="Photo.MsgDelete({id}, {aid}, 1); return false"><img class="icon del_photo_ic"
                                                                                         src="{theme}/images/spacer.gif"
                                                                                         alt=""/>
                    <div>Удалить фотографию</div>
                </a>[/owner]
                <a onClick="Report.Box('photo', '{id}')"><img class="icon compla_ic" src="{theme}/images/spacer.gif"
                                                              alt=""/>
