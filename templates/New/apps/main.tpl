...
<div class="search_form_tab">
    <img src="{theme}/images/loading_mini.gif" class="fl_r no_display" id="apps_se_load"
         style="margin-left:730px;margin-top:8px;position:absolute"/>
...
<div id="apps_all">
    ...
    <div class="clear" style="height:20px"></div>
    [but-preload]
    <div class="public_wall_all_comm apps_but cursor_pointer" onClick="apps.showMoreOld()"><span
                id="apps_text_load_old">Показать больше приложений</span></div>
    [/but-preload]
    <div class="apps_block" style="margin-right:20px">
    ...
    <div class="clear" style="height:20px"></div>
    [but-preload-2]
    <div class="public_wall_all_comm apps_but2 cursor_pointer" onClick="apps.showMore()"><span id="apps_text_load">Показать больше приложений</span>
    </div>
    [/but-preload-2]
</div>
