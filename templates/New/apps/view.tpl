<div class="miniature_box apps_box_pos_marg">
    <div class="miniature_pos apps_box_pos">
        <div class="miniature_title fl_l apps_box_text">Запуск игры</div>
        <a class="cursor_pointer fl_r" onClick="viiBox.clos('ap', 1, '/apps')">Закрыть</a>
        <div class="clear"></div>
        [yes-game]
        ...
        <div class="apps_view_block">
            ...
            <div class="button_div fl_r">
                <button onClick="Page.Go('/app{app-id}')">Запустить игру</button>
            </div>
            <div class="clear"></div>
        </div>
        [poster]
        <div class="appsfh" onClick="Page.Go('/app{app-id}')">
        ...
        [/poster][/yes-game]
        [no-game]
        <div class="info_center"><br/><br/>Игра не найдена.<br/><br/><br/></div>
        [/no-game]
        <div class="clear"></div>
    </div>
