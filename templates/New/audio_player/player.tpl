...
<div class="staticPlbgTitle">
    ...
    <div class="staticpl_translate" onClick="player.translate()"
         onMouseOver="myhtml.title('1', 'Транслировать на мою страницу', 'xPlayerTranslate')"
         id="xPlayerTranslate1"></div>
    <div class="clear"></div>
</div>
<div class="staticpl_seachbg">
    <img src="{theme}/images/loading_mini.gif" class="fl_r no_display" id="jQpLoad"
