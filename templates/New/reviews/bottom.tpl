...
<div class="clear"></div>
<div class="rate_alluser cursor_pointer" style="margin:12px -12px -15px -12px" onClick="reviewsPage()" id="reviews_but">
    <div id="load_reviews_but">Показать больше отзывов</div>
</div>