...
<div class="cover_edit_title doc_full_pg_top" style="padding-top:13px">
    ...
    <div class="button_div fl_r">
        <button onClick="PublicAudioSearch(); return false" id="se_but_load">Найти</button>
    </div>
    <div class="clear"></div>
</div>
<div class="clear"></div>
<div id="seResult">
    ...
    <div class="allbar_title" style="margin-bottom:0px">{audio-num} | <a href="/{adres}"
                                                                         onClick="Page.Go(this.href); return false"
                                                                         style="font-weight:normal">К сообществу</a>
    </div>
    [no]
