...
[/owner]
[not-owner][cover]
<div class="cover_all_user"><img src="{cover}" width="800" id="cover_img" {cover-param-5} /></div>
[/cover][/not-owner]
<div class="ava">
    [owner]
    ...
    <div class="menuleft" style="margin-top:5px">
        ...
        <a href="/" onClick="subscriptions.add({user-id}); return false" id="lnk_unsubscription">
            ...
            <div><span id="text_add_subscription">Подписаться на обновления</span> <img
                        src="/templates/Default/images/loading_mini.gif" alt="" id="addsubscription_load"
        ...
        <a href="/" onClick="fave.add({user-id}); return false" id="addfave_but">
            ...
            <div><span id="text_add_fave">Добавить в закладки</span> <img
                        src="/templates/Default/images/loading_mini.gif" alt="" id="addfave_load" class="no_display"/>
            </div>
        </a>
        [/no-fave]
        [yes-fave]
        ...
        <a href="/" onClick="settings.addblacklist({user-id}); return false" id="addblacklist_but">
            ...
            <div><span id="text_add_blacklist">Заблокировать</span> <img
                        src="/templates/Default/images/loading_mini.gif" alt="" id="addblacklist_load"
    ...
    <div class="leftcbor">
        ...
        <div id="happyBLockSess">
            <div class="albtitle">
                ...
                <div class="profile_happy_hide"><img src="{theme}/images/hide_lef.gif"
        ...
        [/subscriptions]
        [groups]
        <div class="albtitle cursor_pointer" onClick="groups.all_groups_user('{user-id}')">Сообщества <span
                    id="groups_num">{groups-num}</span></div>
        <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">
            {groups}
            <div class="clear"></div>
        </div>
...
<div class="profiewr">
    ...
    [/owner]
    <div class="titleu">{name} {lastname} {user_real}<a class="fl_r color777"
                                                        style="text-decoration:none"><b>{online}</b></a></div>
    <div class="status">
        <div>[owner]<a href="/" id="new_status" onClick="gStatus.open(); return false">[/owner][blacklist]{status-text}
                [/blacklist][owner]</a>[/owner]
        </div>
        ...
        [/owner]
        [owner]<a href="#" onClick="gStatus.open(); return false" id="status_link" [status]class="no_display" [/status]>установить
        статус</a>[/owner]
    </div>
