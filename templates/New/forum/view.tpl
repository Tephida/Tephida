...
<div class="search_form_tab" style="margin-top:-9px;background:#fff">
    <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
        <a href="/public{id}" onClick="Page.Go(this.href); return false;">
            <div><b>К сообществу</b></div>
        </a>
        <a href="/forum{id}" onClick="Page.Go(this.href); return false;">
            <div><b>Обсуждения</b></div>
        </a>
        <div class="buttonsprofileSec"><a href="/forum{id}?act=view&id={fid}"
                                          onClick="Page.Go(this.href); return false;">
                <div><b>Просмотр темы</b></div>
            </a></div>
        [admin-2]
        <div class="fl_r">
            <div class="sett_privacy" style="margin-bottom:0px" onClick="settings.privacyOpen('msg')"
                 id="privacy_lnk_msg">Редактировать
            </div>
            <div class="sett_openmenu no_display" id="privacyMenu_msg"
                 style="margin-left:-3px;margin-top:-1px;width:115px">
...
<div class="allbar_title forum_view_title">В теме <span id="msgNumJS">{msg-num}</span> <span
            id="langMsg">сообщение</span></div>
<div class="forum_msg_border">
    ...
    <div class="forum_text">
        ...
        <span class="color777">{date} [admin-2]<span id="editLnk">&nbsp;|&nbsp; <a href="/"
                                                                                   onClick="Forum.EditText(); return false">Редактировать</a></span>[/admin-2]</span>
    </div>
    <div class="clear"></div>
</div>
[msg]
<div class="cursor_pointer" onClick="Forum.MsgPage('{fid}'); return false" id="forum_msg_lnk"
     style="margin-top:-1px;margin-left:8px;margin-right:7px">
    <div class="public_wall_all_comm" id="load_forum_msg_lnk" style="margin-left:0px">Показать предыдущие сообщения
    </div>
</div>[/msg]
