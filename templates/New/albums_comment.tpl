<div id="comment_all_{id}">
    <div class="wallrecord comm_wr_all fl_l">
        ...
        <div style="float:left;width:595px">
            ...
            <div class="infowalltext">{date} [owner]&nbsp;|&nbsp; <a href="/"
                                                                     onClick="comments.delet_page_comm({id}, '{hash}'); return false"
                                                                     id="full_del_but_{id}">Удалить</a>[/owner]
            </div>
        </div>
    </div>
    <div class="comment_photo"><a href="/photo{user-id}_{pid}{aid}_sec={section}"
                                  onClick="Photo.Show(this.href); return false"><img src="{photo}" alt=""/></a></div>
    <div class="clear"></div>
</div>