<script type="text/javascript">
    ...
    var photoUpload = {
        ...
        startUpload: function (file) {
            ...
            xhr.open("POST", '/index.php?go=albums&act=upload&aid={aid}', true);
...
<div class="load_photo_but" style="margin-left:245px;">
    <div class="fl_l">
        <div class="button_div fl_l">
            <button onclick="this.nextSibling.click();">Выберите фотографии</button>
            <input type="file" multiple="true" style="display:none;" onchange="photoUpload.go(this);"></div>
    ...
    <div class="button_div_gray fl_l" style="margin-left:10px;">
        <button onClick="Page.Go('/albums/view/{aid}'); return false;">Просмотр альбома</button>
    </div>
</div>
<div class="swf_loaded" id="upBar">
    <div class="video_show_bg swf_uploaded">
        <div class="upProcLotitle" id="status"></div>
        <div style="background:url('{theme}/images/progress_grad.gif?1');border:1px solid #45688e;height:18px;position:absolute"
             id="uploadproc"></div>
