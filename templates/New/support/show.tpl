<div class="search_form_tab" style="background:#fff;margin-top:-9px">
    <div class="buttonsprofile albumsbuttonsprofile" style="height:22px">
        ...
        <div class="activetab"><a href="/support?act=show&qid={qid}" onClick="Page.Go(this.href); return false;">
                <div><b>Просмотр вопроса</b></div>
            </a></div>
    </div>
</div>
    ...
    <div style="float:left;width:680px;margin-bottom:10px">
        <div class="walltext">
            <div style="padding-left:2px">
                {question}
                <br/><span class="color777">{date} &nbsp;|&nbsp;</span> <a href="/"
