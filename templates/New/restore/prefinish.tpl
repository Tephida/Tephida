...
<div class="note_add_bg support_bg" id="step1">
    <div style="width:310px"><b>{name}</b>, в целях безопасности вашего аккаунта администрация <b>Сайта</b> рекомендует
        вам регулярно менять пароль. Эта процедура не займет у вас много времени, но значительно уменьшит риски доступа
        третьих лиц к вашей учетной записи. Для изменения пароля к аккаунту введите новый пароль в специальное поле под
        данным сообщением.
    </div>
...
<div class="note_add_bg support_bg no_display" id="step2"><b>{name}</b>, Ваш пароль был успешно изменён на новый, теперь
    Вы можете зайти на сайт используя новый пароль.
</div>