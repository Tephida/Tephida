...
<div class="note_text">{full-text}</b></u></i>
    <div class="clear"></div>
</div>
<div class="note_inf_panel note_text_full">
    <span class="online">{date}</span> &nbsp;|&nbsp; {comm-num} &nbsp;|&nbsp; <a class="cursor_pointer"
                                                                                 onClick="Report.Box('note', '{note-id}')">Пожаловаться
        на заметку</a>[owner]&nbsp;|&nbsp; <a href="/notes/edit/{note-id}" onClick="Page.Go(this.href); return false">Редактировать</a>
