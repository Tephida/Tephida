...
<div class="wallrecord comm_wr news_comm_wr" id="wall_record_{rec-id}" style="padding-bottom:4px;margin-top:5px">
    <div style="float:left;width:60px">
        <div class="ava_mini"><a href="/{link}{author-id}" onClick="Page.Go(this.href); return false"><img src="{ava}"
                                                                                                           alt=""/></a>
    ...
    <div style="float:left;width:710px;margin-left:0px">
        ...
        <div class="infowalltext_f clear">
            <div class="fl_l">{action-type} {date} [comments-link]<span id="fast_comm_link_{rec-id}"
                                                                        class="fast_comm_link">&nbsp;|&nbsp; <a href="/"
                                                                                                                id="fast_link_{rec-id}"
                                                                                                                onClick="wall.open_fast_form('{rec-id}'); wall.fast_open_textarea('{rec-id}'); return false">Комментировать</a></span>[/comments-link]
            </div>
            [wall]
