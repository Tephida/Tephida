...
<div class="miniature_box">
    <div class="miniature_pos" style="width:400px">
        <div class="miniature_title fl_l apps_box_text">Повышения рейтинга</div>
        <a class="cursor_pointer fl_r" style="font-size:12px" onClick="viiBox.clos('rate', 1)">Закрыть</a>
        <div class="clear"></div>
        ...
        <div class="rating_iny">
            ...
            <div class="rating_text_balance">У Вас <span id="rt">останется</span> <b id="num">{num}</b> убм</div>
