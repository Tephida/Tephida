...
<div class="apps_faslh_pos">
	...
	<embed width="795" height="495" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" allowscriptaccess="sameDomain" quality="high" src="/uploads/apps/{games}">
	</object>
</div>
<div class="clear"></div>