...
maxlength="80" />
<div class="fl_r"><button onClick="PublicAudioSearch(); return false" class="button" id="se_but_load">Найти</button></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
<div id="seResult">
<div class="msg_speedbar margin_top_10 margin_bottom_10">{audio-num} | <a href="/{adres}" onClick="Page.Go(this.href); return false" style="font-weight:normal">К сообществу</a></div>
