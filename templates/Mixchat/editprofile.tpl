...
<div class="texta" id="sp_text">{sp-text}</div>
 <div class="padstylej fl_l">
  ...
  <img src="{theme}/images/close_a_wall.png" class="sp_del" onClick="sp.del()" />
 </div>
<div class="mgclr"></div>
...
<div class="texta">&nbsp;</div>
 <div class="button_div fl_l"><button id="saveform">Сохранить</button></div>
 <div class="mgclr"></div>
</div>
[/general]
[contact]
