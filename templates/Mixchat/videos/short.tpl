<div class="onevideo page_bg border_radius_5" id="video_{id}" style="padding-top:20px;padding-bottom:15px">
 ...
 [owner]<div class="onevideo_inf"><a href="/" onClick="videos.editbox({id}); return false">Редактировать</a> <a href="/" class="fl_r" onClick="videos.delet({id}); return false">Удалить</a></div>[/owner]
