<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:48px">
 ...
 <div class="buttonsprofileSec"><a href="/groups?act=admin" onClick="Page.Go(this.href); return false;">Управление сообществами</a></div>
...
<div class="msg_speedbar clear" [yes]style="margin-bottom:0px;border-bottom:0px"[/yes]>[yes]Вы руководитель в {num}[/yes][no]Вы не управляете ни одним сообществом[/no]</div>
