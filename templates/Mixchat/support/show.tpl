<div class="buttonsprofile">
 <a href="/support" onClick="Page.Go(this.href); return false;">[group=4]Вопросы от пользователей[/group][not-group=4]Мои вопросы[/not-group]</a>
 <div class="activetab"><a href="/support?act=show&qid={qid}" onClick="Page.Go(this.href); return false;">Просмотр вопроса</a></div>
</div>
...
<div class="walltext">
 <div style="padding-left:2px">
  {question}
  <br /><span class="color777">{date}</span> <a href="/" class="fl_r" onClick="support.delquest('{qid}'); return false">Удалить вопрос</a>
 </div>
</div>
</div>
<div class="clear"></div>
