...
<input type="hidden" id="typePlay" value="standart" />
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
  ...
  <div class="buttonsprofileSec"><a href="/forum{id}?act=view&id={fid}" onClick="Page.Go(this.href); return false;">Просмотр темы</a></div>
  [admin-2]<div class="fl_r" style="margin-top:10px">
...
<div class="msg_speedbar margin_top_10 margin_bottom_10">В теме <span id="msgNumJS">{msg-num}</span> <span id="langMsg">сообщение</span></div>
...
<div class="forum_text">
 ...
 <span class="color777">{date} [admin-2]<span id="editLnk"><a href="/" class="fl_r" onClick="Forum.EditText(); return false">Редактировать</a></span>[/admin-2]</span>
</div>
<div class="clear"></div>
</div>
[msg]<div class="cursor_pointer" onClick="Forum.MsgPage('{fid}'); return false" id="forum_msg_lnk" style="margin-top:-1px"><div class="public_wall_all_comm border_radius_5" id="load_forum_msg_lnk" style="margin-left:0px">Показать предыдущие сообщения</div></div>[/msg]
<span id="msgPrev"></span>
<span id="msg">{msg}</span>
<div class="note_add_bg clear support_addform forum_addmsgbg margin_top_10 border_radius_5 [/add-form]no_display[/add-form]" style="margin-top:10px">
<div class="ava_mini">
