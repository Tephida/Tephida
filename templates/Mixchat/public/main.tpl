...
<div class="profiewr profiewr2">
 ...
 [admin]<div class="set_status_bg no_display" id="set_status_bg">
  <input type="text" id="status_text" class="status_inp" value="{status-text}" style="width:645px;" maxlength="255" onKeyPress="if(event.keyCode == 13)gStatus.set('', 1)" />
 ...
 [not-admin][status]<div class="status border_radius_5">[/status][/not-admin]
 [admin]<div class="status border_radius_5">[/admin]
 ...
 [admin]</div>[/admin]
 [not-admin][status]</div>[/status][/not-admin]
 ...
 [admin]<div class="public_editbg border_radius_5 fl_l no_display" id="edittab1">
 ...
 <a href="/forum{id}" onClick="Page.Go(this.href); return false" class="fl_l" style="text-decoration:none;height:10px"><div class="albtitle albtitle2">{forum-num} <b id="langForum">Нет обсуждений</b></div></a>
 <a href="/forum{id}?act=new" onClick="Page.Go(this.href); return false" class="fl_r {no}" style="text-decoration:none"><div class="albtitle albtitle2">Новая тема</div></a><div class="albtitle albtitle2">&nbsp;</div>
 <div class="clear"></div><div style="margin-top:-11px">{thems}</div><div class="clear"></div>
 </div>[/discussion]
 
 <div class="page_bg border_radius_5 margin_top_10 page_bg_wall" style="padding-bottom:0px[admin];padding-bottom:20px[/admin]">
 
 <div class="albtitle albtitle2" style="border-bottom:0px">{rec-num}</div>
 [admin]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-left:-13px;margin-top:-15px;margin-bottom:-10px">
  <input type="hidden" value="Что у Вас нового?" id="wall_input_text" />
  <input type="text" class="msg_se_inp" value="Что у Вас нового?" onMouseDown="wall.form_open(); return false" id="wall_input" style="margin:0px;width:600px" />
  <div class="no_display" id="wall_textarea">
   ...
   <div class="wall_attach fl_r" style="margin-right:-14px" onMouseOver="wall.attach_menu('open', this.id, 'wall_attach_menu')" onMouseOut="wall.attach_menu('close', this.id, 'wall_attach_menu')" id="wall_attach">Прикрепить</div>
 ...
 <div class="cursor_pointer {wall-page-display}" onClick="groups.wall_page('{id}'); return false" id="wall_all_records"><div class="border_radius_5 public_wall_all_comm" id="load_wall_all_records">к предыдущим записям</div></div>
