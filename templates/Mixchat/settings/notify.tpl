...
<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
 ...
 <div class="buttonsprofileSec"><a href="/settings/notify" onClick="Page.Go(this.href); return false;">Оповещения</a></div>
</div>
<div class="margin_top_10"></div><div class="msg_speedbar clear">Оповещения по электронной почте</div>
