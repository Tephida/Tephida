...
<div class="err_yellow name_errors border_radius_5 {code-1}" style="font-weight:normal;margin-top:25px">Код активации из письма с текущего почтового ящика принят. Осталось подтвердить код активации в письме, отправленном на новый почтовый ящик.</div>
<div class="err_yellow name_errors border_radius_5 {code-2}" style="font-weight:normal;margin-top:25px">Код активации из письма с нового почтового ящика принят. Осталось подтвердить код активации в письме, отправленном на текущий почтовый ящик.</div>
<div class="err_yellow name_errors border_radius_5 {code-3}" style="font-weight:normal;margin-top:25px">Адрес Вашей электронной почты был успешно изменен на новый.</div>
...
<div class="texta">Повторите пароль:</div>
 <input type="password" id="new_pass2" class="inpst" maxlength="100" style="width:150px;" onMouseOver="myhtml.title('', 'Введите еще раз новый пароль', 'new_pass2')" />
...
<div class="texta">Текущий адрес:</div><div style="color:#555;margin-top:2px;margin-bottom:10px">{email}</div><div class="mgclr"></div>
...
<div class="margin_top_10"></div><div class="msg_speedbar clear">Настройки блоков</div>
<div class="page_bg border_radius_5 margin_top_10">
<div class="html_checkbox" id="b_design" onClick="myhtml.checkbox(this.id); savblock()">На всех страницах применять мои настройки дизайна</div>
...
<div class="html_checkbox" id="b_friends" onClick="myhtml.checkbox(this.id); savblock()">Друзья</div>
 <div class="clear" style="height:10px"></div>
<div class="html_checkbox" id="b_friends_online" onClick="myhtml.checkbox(this.id); savblock()">Друзья на сайте</div>
 <div class="clear" style="height:10px"></div>
