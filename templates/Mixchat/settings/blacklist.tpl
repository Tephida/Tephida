<div class="buttonsprofile">
 ...
 <div class="buttonsprofileSec"><a href="/settings/blacklist" onClick="Page.Go(this.href); return false;">Черный список</a></div>
 <a href="/settings/notify" onClick="Page.Go(this.href); return false;">Оповещения</a>
</div>
<div class="clear"></div>
[yes-users]<div class="msg_speedbar">В Вашем черном списке находится {cnt}</div>[/yes-users]