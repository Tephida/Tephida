...
.audio_onetrack, .player_mini_mbar{width:760px}
</style>
...
[bottom]<span id="news"></span>
<div onClick="news.page()" id="wall_l_href_news" class="cursor_pointer"><div class="doc_all_but border_radius_5" id="loading_news">Показать предыдущие новости</div></div>[/bottom]