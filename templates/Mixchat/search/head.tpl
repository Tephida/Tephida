...
$(document).ready(function(){
	...
	[search_tab]$(window).scroll(function(){
...
<div class="clear"></div>
[search_tab]<div class="search_sotrt_tab border_radius_5">
...
<div class="clear"></div>
[yes]<div class="msg_speedbar margin_bottom_10" [search_tab]style="margin-right:297px"[/search_tab]>Найдено {count}</div>[/yes]
