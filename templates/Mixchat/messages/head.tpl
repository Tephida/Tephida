...
<div class="buttonsprofile">
 ...
 <div class="msg_se_bg">
  <input type="text" value="{query}" class="msg_se_inp" onBlur="if(this.value==''){this.value='Поиск по полученным сообщениям';this.style.color = '#c1cad0';}" onFocus="if(this.value=='Поиск по полученным сообщениям'){this.value='';this.style.color = '#000'}" id="msg_query" maxlength="130" onKeyPress="if(event.keyCode == 13)messages.search();" />
...
<div class="buttonsprofile">
 ...
 <div class="msg_se_bg"><input type="text" value="{query}" class="msg_se_inp" onblur="if(this.value==''){this.value='Поиск по отправленным сообщениям';this.style.color = '#c1cad0';}" onfocus="if(this.value=='Поиск по отправленным сообщениям'){this.value='';this.style.color = '#000'}" id="msg_query" maxlength="130" onKeyPress="if(event.keyCode == 13)messages.search(1);" />
