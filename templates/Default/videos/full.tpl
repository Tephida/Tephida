<div id="video_show_{vid}" class="video_view" onClick="videos.setEvent(event, {owner-id}, '{close-link}')">
    ...
    <div class="video_show_bg">
        <div class="video_show_object">
            ...
            [not-owner]
            <div id="addok"><a href="/" onClick="videos.addmylist('{vid}'); return false">Добавить в Мои Видеозаписи</a>
            </div>
            [/not-owner]
        </div>
        <div class="video_show_panel" id="video_del_info">
            ...
            <div class="photo_rightcol">
                ...
                <div class="menuleft" style="width:220px;">
                    [owner]<a href="/" onClick="videos.editbox({vid}); return false"><img class="icon editphoto_ic"
                                                                                          src="{theme}/images/spacer.gif"
                                                                                          alt=""/>
                        <div>Редактировать видеозапись</div>
                    </a>
                    <a href="/" onClick="videos.delet({vid}, 1); return false"><img class="icon del_photo_ic"
                                                                                    src="{theme}/images/spacer.gif"
                                                                                    alt=""/>
                        <div>Удалить видеозапись</div>
                    </a>[/owner]
                    <a onClick="Report.Box('video', '{vid}')"><img class="icon compla_ic"
