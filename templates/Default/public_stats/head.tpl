...
<div class="search_form_tab" style="margin-top:-9px">
    <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
        ...
        <div class="buttonsprofileSec"><a href="/stats?gid={gid}">
                <div><b>Статистика страницы</b></div>
            </a></div>
        <div class="fl_r">
            ...
            <div class="button_div fl_l">
                <button onClick="location.href = '/stats?gid={gid}&m='+$('#month').val()+'&y='+$('#year').val()">
                    Просмотреть
                </button>
            </div>
        </div>
...
<div class="margin_top_10"></div>
<div class="allbar_title" style="font-size:13px;color:#78b27c">Новые участники</div>
<div id="graph-wrapper">
    <div class="graph-container">
...
<div class="margin_top_10"></div>
<div class="allbar_title" style="font-size:13px;color:#82a2cd">Вышедшие участники</div>
<div id="graph-wrapper">
    <div class="graph-container">
