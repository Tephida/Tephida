...
<div class="note_add_bg support_bg" id="step1">
    ...
    />
    <div class="button_div fl_l margin_left" style="margin-top:11px">
...
<div class="note_add_bg support_bg no_display" id="step3">На ваш электронный ящик были высланы инструкции по
