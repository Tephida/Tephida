...
<div style="height:108px">
    <div class="search_form_tab" style="margin-top:-9px;border:0px;position:absolute;width:774px">
        ...
        <div class="button_div fl_l">
            <button onClick="reviews.send()" id="sending">Оставить отзыв</button>
        </div>
        <div class="clear"></div>
    </div>
</div>
...
[not-logged]
<div style="margin-top:-18px"></div>[/not-logged]
<div class="err_yellow no_display" id="ok_send" style="font-weight:normal;margin-top:30px">Ваш отзыв успешно отправлен,
    после проверки модератором он будет добавлен на сайт.
</div>