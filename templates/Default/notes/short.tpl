<div id="note_{note-id}">
    ...
    <div class="note_inf_panel">
        ...
        <a href="/notes/edit/{note-id}" onClick="Page.Go(this.href); return false">Редактировать</a> &nbsp;|&nbsp; <a
                href="/" onClick="notes.delet({note-id}, false, {user-id}); return false">Удалить</a>[/owner]
    </div>
    <div class="clear"></div>
</div>