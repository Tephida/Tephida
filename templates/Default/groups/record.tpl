[record]
<div class="wallrecord wall_upage public_wall" id="wall_record_{rec-id}"
    ...
    <div class="newwallX wall_rec_autoresize">
        ...
        <div class="size10 infowalltext_f clear">
            <div class="fl_l"><a href="/wallgroups{user-id}_{rec-id}" onClick="Page.Go(this.href); return false"
...
[/record]
[all-comm]
<div class="cursor_pointer" onClick="groups.wall_all_comments('{rec-id}', '{user-id}'); return false"
...
<div class="wall_fast_block" id="wall_fast_comment_{comm-id}"
    ...
    <div class="wall_fast_date">{date} [not-owner]&nbsp;-&nbsp; <a href="#"
                ...
                onClick="groups.comm_wall_delet('{comm-id}', '{user-id}'); return false">Удалить</a>[/owner]
    </div>
    <div class="clear"></div>
</div>[/comment]
[comment-form]
