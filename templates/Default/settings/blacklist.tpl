<div class="search_form_tab" style="margin-top:-9px">
    <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
        ...
        <div class="buttonsprofileSec"><a href="/settings/blacklist" onClick="Page.Go(this.href); return false;">
...
<div class="allbar_title">В Вашем черном списке находится {cnt}</div>[/yes-users]