<img src="{theme}/images/concept-people.webp" alt="people" style="width: 100%">
...
<div class="note_add_bg support_bg" id="step1" style="margin-top:-10px">
    ...
    <div style="padding-left:130px">
        ...
        <div class="button_div fl_l">
            <button onClick="reg.step1(); return false" style="width:161px">Следующий шаг</button>
        </div>
    </div>
    <div class="clear"></div>
</div>
...
<div class="note_add_bg support_bg no_display" id="step2" style="margin-top:-10px">
    ...
    <div style="padding-left:130px">
        ...
        <div class="clear"></div>
        <select id="country" class="inpst sel_reg" onChange="Profile.LoadCity(this.value); return false;">
            <option value="0">Выбрать страну</option>{country}
...
<div class="clear"></div></span>
        ...
        <div class="button_div fl_l">
            <button onClick="reg.step2(); return false" style="width:161px">Следующий шаг</button>
        </div>
    </div>
    <div class="clear"></div>
</div>
...
<div class="note_add_bg support_bg no_display" id="step3" style="margin-top:-10px">
    ...
    <div style="padding-left:130px">
        ...
        <div class="clear"></div>
        <div class="button_div fl_l">
            <button onClick="reg.finish(); return false" style="width:161px">Отправить</button>
        </div>
    </div>
    <div class="clear"></div>
</div>