...
<div class="ava fl_r" style="margin-right:0px" onMouseOver="groups.wall_like_users_five_hide()">
    ...
    <div class="menuleft" style="margin-top:5px">
        ...
        [admin]<a href="/" onClick="groups.loadphoto('{id}'); return false"><img class="icon editphoto_ic"
                                                                                 src="{theme}/images/spacer.gif"
                                                                                 alt=""/>
            <div>Изменить фотографию</div>
        </a>
        <span id="del_pho_but" class="{display-ava}"><a href="/" onClick="groups.delphoto('{id}'); return false;"><img
                        class="icon del_photo_ic" src="{theme}/images/spacer.gif" alt=""/><div>Удалить фотографию</div></a></span>
        <a href="/" onClick="groups.editform(); return false"><img class="icon ic_edit" src="{theme}/images/spacer.gif"
                                                                   alt=""/>
    ...
    [videos]
    <div class="public_vlock cursor_pointer" onClick="Page.Go('/public/videos{id}'); return false">Видеозаписи</div>
    <div class="public_bg">
        [yesvideo]
        <div class="color777 public_margbut">{videos-num} <span id="langNumricVide"></span></div>
        [/yesvideo]
        {videos}
        [novideo]
        <div class="line_height color777" align="center">Ролики с Вашим участием и другие видеоматериалы<br/>
            <a href="/public/videos{id}" onClick="Page.Go(this.href); return false">Добавить видеозапись</a></div>
        [/novideo]
    </div>
    [/videos]
    [feedback]
    <div class="public_vlock cursor_pointer" onClick="groups.allfeedbacklist('{id}')">Контакты [yes][admin]<a
    ...
    [/feedback]
    [audios]
    <div class="public_vlock cursor_pointer" onClick="Page.Go('/public/audio{id}'); return false">Аудиозаписи</div>
    <div class="public_bg">
        [yesaudio]
...
<div class="profiewr">
    <div id="public_editbg_container">
        <div class="public_editbg_container">
            <div class="fl_l" style="width:560px">
                ...
                <div class="status">
                    <div>[admin]<a href="/" id="new_status" onClick="gStatus.open(); return false">[/admin]{status-text}
                            [admin]</a>[/admin]
                    </div>
                    ...
                    <div class="status_tell_friends no_display" style="width:215px">
                        ...
                        <div class="html_checkbox" id="tell_friends"
                             onClick="myhtml.checkbox(this.id); gStatus.startTellPublic('{id}')">Рассказать подписчикам
                            сообщества
                        </div>
                    </div>
                    [/admin]
            ...
            [admin]
            <div class="public_editbg fl_l no_display" id="edittab1">
    ...
    [discussion]<a href="/forum{id}" onClick="Page.Go(this.href); return false" class="fl_l"
                   style="text-decoration:none">
        <div class="albtitle" style="border-bottom:0px">{forum-num} <b id="langForum">Нет обсуждений</b></div>
    </a>
    <a href="/forum{id}?act=new" onClick="Page.Go(this.href); return false" class="fl_r {no}"
       style="text-decoration:none">
        <div class="albtitle" style="border-bottom:0px;color:#ddd">Новая тема</div>
    </a>
    <div class="clear"></div>{thems}
    <div class="clear"></div>
    [/discussion]
    ...
    <div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-5px">
        ...
        <input type="text" class="wall_inpst" value="Что у Вас нового?" onMouseDown="wall.form_open(); return false"
               id="wall_input" style="margin:0px"/>
   ...
   >
            ...
            <div id="attach_block_vote" class="no_display">
                ...
                <div class="attach_link_block_te">
                    ...
                    <img class="fl_l cursor_pointer" style="margin-top:2px;margin-left:5px"
                         ...
                         onClick="Votes.RemoveForAttach()"/></div>
            ...
            <div class="wall_attach_menu no_display"
                ...
                <div class="wall_attach_icon_video" id="wall_attach_link"
                     onClick="wall.attach_addvideo_public(0, 0, '{id}')">Видеозапись
                </div>
                <div class="wall_attach_icon_audio" id="wall_attach_link" onClick="wall.attach_addaudio()">Аудиозапись
                </div>
    ...
    <div class="cursor_pointer {wall-page-display}" onClick="groups.wall_page('{id}'); return false"
         id="wall_all_records">
        <div class="public_wall_all_comm" id="load_wall_all_records" style="margin-left:0px">к предыдущим записям</div>
    </div>
